...
public class EstudioController {
    ...
    private String viewList= "view/estudio/lEstudio.html";
    private String redirectList= "redirect:/estudio/lista";
    private String viewEdit= "view/estudio/eEstudio.html";
    ...
    public String listar(Model model) {
        try {
            Collection<EstudioEntity> listaEstudio = estudioService.obtenerTodos();
    ...
    @GetMapping("/alta")
    public String alta(EstudioEntity estudioEntity, Model model) {
    ...
    public String consultar(@PathVariable("id") Long estudioId, Model model) {

        try {

            EstudioEntity estudioEntity = estudioService.buscarEstudio(estudioId);
            model.addAttribute("estudioEntity", estudioEntity);
    ...
    public String modificar(@PathVariable("id") Long idEstudio, Model model) {

        try {
            EstudioEntity estudioEntity = estudioService.buscarEstudio(idEstudio);
            model.addAttribute("estudioEntity", estudioEntity);
            model.addAttribute("isDisabled", false);
    ...
    @GetMapping("/baja/{id}")
    public String baja(@PathVariable("id") Long idEstudio, RedirectAttributes attributes, Model model) {
        System.out.println("aslkdjas");
        try {

            estudioService.eliminarEstudio(idEstudio);
    ...
    public String aceptarEdit(EstudioEntity estudio, BindingResult result, RedirectAttributes attributes, Model model){
        try {
